...
public class ThongKePanel extends javax.swing.JPanel {
   ...
   private DateChooser chDate = new DateChooser();
    ...
    public ThongKePanel() {
        ...
        chDate.addActionDateChooserListener(new DateChooserAdapter() {
            ...
            public void dateBetweenChanged(DateBetween date, DateChooserAction action) {
                ...
                String dateFrom = sdf.format(date.getFromDate());
                String toDate = sdf.format(date.getToDate());
                loadThang("Select SUM(cthd.DonGia) as DoanhThu,hd.NgayTao as Thang from ChiTietHoaDon cthd \n"
                        + "join HoaDon hd \n"
                        + "on hd.Id = cthd.IdHD\n"
                        + "where hd.NgayTao between '" + dateFrom + "' and '" + toDate + "'\n"
                        + "group by hd.NgayTao");
        ...
        chDate.addActionDateChooserListener(new DateChooserAdapter() {
            ...
            public void dateBetweenChanged(DateBetween date, DateChooserAction action) {
                ...
                String dateFrom = sdf.format(date.getFromDate());
                String toDate = sdf.format(date.getToDate());
                loadNam("Select SUM(cthd.DonGia) as DoanhThu,hd.NgayTao as Thang from ChiTietHoaDon cthd \n"
                        + "join HoaDon hd \n"
                        + "on hd.Id = cthd.IdHD\n"
                        + "where hd.NgayTao between '" + dateFrom + "' and '" + toDate + "'\n"
                        + "group by hd.NgayTao");
        ...
        chDate.addActionDateChooserListener(new DateChooserAdapter() {
            ...
            public void dateBetweenChanged(DateBetween date, DateChooserAction action) {
                ...
                String dateFrom = sdf.format(date.getFromDate());
                String toDate = sdf.format(date.getToDate());
                loadDoanhThuNgay("Select SUM(cthd.DonGia) as DoanhThu,hd.NgayTao as Thang from ChiTietHoaDon cthd \n"
                        + "join HoaDon hd \n"
                        + "on hd.Id = cthd.IdHD\n"
                        + "where hd.NgayTao between '" + dateFrom + "' and '" + toDate + "'\n"
                        + "group by hd.NgayTao");
        ...
        tblHoaDon("select MaHD,NgayTao,NgayThanhToan,TinhTrang from HoaDon");
    ...
    public void tblHoaDon(String sql) {
        try {
            ...
            while (rs.next()) {
                ...
                modelHoaDon.addRow(new Object[]{tblHD.getRowCount() + 1, ma, ngayTao, ngayThanhToan, tinhTrang});
            }
            rs.close();
            ps.close();
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        cb_nhanVien.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tất cả", "Nam", "Nữ", "Bán nhiều nhất", "Không bán được" }));
